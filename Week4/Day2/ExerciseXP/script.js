...
let calculateTip = () => {
    ...
    switch (true) {
        case (bill > 0 && bill < 50): return console.log(bill + (bill * 0.2));
        case (bill >= 50 && bill < 200): return console.log(bill + (bill * 0.15));
        case (bill >= 200): return console.log(bill + (bill * 0.1));
        default: return console.log("Invalid amount")
    }
}
