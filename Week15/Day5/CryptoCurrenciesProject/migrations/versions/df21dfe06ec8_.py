...
Revision ID: df21dfe06ec8
Revises: 
Create Date: 2022-04-07 22:32:10.252587
...
def upgrade():
    ...
    sa.Column('first_historical_data', sa.String(length=50), nullable=True),
    sa.Column('last_historical_data', sa.String(length=50), nullable=True),
